...
return [
    ...
    'Security' => [
        ...
        'cookieKey' => '%D*G-KaPdSgVkYp3s5v8y/B?E(H+MbQe'
    ],
    ...
    'Cache' => [
        ...
        'apiResultsShort' => [
            'className' => FileEngine::class,
            'prefix' => 'api_results_short_',
            'path' => CACHE,
            'duration' => '+1 minute',
        ],
        'apiResultsLong' => [
            'className' => FileEngine::class,
            'prefix' => 'api_results_long_',
            'path' => CACHE,
            'duration' => '+5 hour',
        ],
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 587,
            'timeout' => 30,
            'username' => 'mktcasiraghi@gmail.com',
            'password' => 'jpvvsxniktbhvbso',
            'tls' => true,
            'client' => null,
        ...
        'test' => [
            ...
            'port' => 2525,
            'username' => 'c4464ed0a0d3a6',
            'password' => 'bb9d322a8b418f',
            'className' => 'Smtp'
        ],
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => ['noreply@casiraghi.com.ar' => 'Casiraghi Hnos'],
            /*
